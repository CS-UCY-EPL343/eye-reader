angular
     ...
     */
    .controller("statisticsCtrl", ["$scope", "$q", "Server", "$http", "ConnectionMonitor", "sharedProps", "$timeout", "$ionicLoading", "$window", "$rootScope",
        function ($scope, $q, Server, $http, ConnectionMonitor, sharedProps, $timeout, $ionicLoading, $window, $rootScope) {
            /*
